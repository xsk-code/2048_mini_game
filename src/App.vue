...
<template>
  <view class="app-container">
    ...
    <view class="game-container">
      ...
      <view class="board" :class="{ dark: gameStore.isDark }">
        <view
          v-for="i in 16"
          :key="i"
          class="cell"
        ...
        <view v-if="gameStore.isGameOver" class="game-overlay">
          <text class="message">Game Over</text>
          <text class="sub-message">Score: {{ gameStore.score }}</text>
        </view>

        <view v-if="gameStore.hasWon && !gameStore.keepPlaying" class="game-overlay">
